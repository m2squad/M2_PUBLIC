...
WPN1 = gg.multiChoice({
  ...
  if WPN1 == nil then
    ...
    if WPN1[1] == true then PIKASQUAD() end
    if WPN1[2] == true then PIKASAFE() end
    if WPN1[3] == true then PIKAWALLHACK() end
    if WPN1[4] == true then PIKABRT() end
    if WPN1[5] == true then PIKACLOSE() end
  end
  PUBGMH = -1
end

function PIKABRT()
  PIKABRT1 = gg.multiChoice({
    "📂 ᴀɴᴛᴇɴᴀ",
    "📂 sᴋʏ",
    "📂 ᴡɪᴅᴇ ᴠɪᴇᴡ",
    "📂 ᴀɪᴍʙᴏᴛ",
    ...
    "❏  ᴍɪᴄʀᴏ sᴘᴇᴇᴅ",
    "🔙ʙᴀᴄᴋ"
  }, nil, (os.date("┏⎚  ⛛ PIKA ⛛   ᴇʀᴀɴɢᴇʟ 2.0\n┣⎚  sᴄʀɪᴘᴛ ʙʏ・ᴘɪᴋᴀᴄʜᴜ \n┗⎚  ᴛᴏᴅᴀʏ ᴅᴀᴛᴇ: %Y/%m/%d  ᴛɪᴍᴇ: %H:%M:%S\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n          ⚠️ ᴛʜɪs ғᴇᴀᴛᴜʀᴇ ᴏɴʟʏ ғᴏʀ ғᴜɴ ᴍᴀᴄᴛʜ ⚠️\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━")))
     if PIKABRT1 == nil then
  else
    if PIKABRT1[1] == true then ANT() end
    if PIKABRT1[2] == true then SKYS() end
    if PIKABRT1[3] == true then VIEWS() end
    if PIKABRT1[4] == true then AIMS() end
    if PIKABRT1[5] == true then HSM() end
    if PIKABRT1[6] == true then LESS() end
    if PIKABRT1[7] == true then BRT15() end
    if PIKABRT1[8] == true then BRT16() end
    if PIKABRT1[9] == true then BRT17() end
    if PIKABRT1[10] == true then BRT18() end
    if PIKABRT1[11] == true then BRT19() end
    if PIKABRT1[12] == true then BRT20() end
    if PIKABRT1[13] == true then BRT21() end
    if PIKABRT1[14] == true then PIKAHOME() end
  end
  PUBGMH = -1
end
...
function SKYS()
  ...
  if SKY1 == nil then
    ...
    if SKY1[1] == true then SK21() end
    if SKY1[2] == true then SK22() end
    if SKY1[3] == true then SK23() end
    if SKY1[4] == true then SK24() end
    if SKY1[5] == true then PIKAHOME() end
  end
  PUBGMH = -1
end
...
function ANT()
  ...
  if ANTN == nil then
    ...
    if ANTN[1] == true then ANTN1() end
    if ANTN[2] == true then ANTN2() end
    if ANTN[3] == true then ANTN3() end
    if ANTN[4] == true then ANTN4() end
    if ANTN[5] == true then ANTN5() end
    if ANTN[6] == true then ANTN6() end
    if ANTN[7] == true then ANTN7() end
    if ANTN[8] == true then ANTN8() end
    if ANTN[9] == true then ANTN9() end
    if ANTN[10] == true then ANTN10() end
    if ANTN[11] == true then ANTN11() end
    if ANTN[12] == true then PIKAHOME() end
  end
  PUBGMH = -1
end
...
function VIEWS()
  ...
  if WIDEVIEW1 == nil then
    ...
    if WIDEVIEW1[1] == true then cww1() end
    if WIDEVIEW1[2] == true then cww2() end
    if WIDEVIEW1[3] == true then cww3() end
    if WIDEVIEW1[4] == true then PIKAHOME() end
  end
  PUBGMH = -1
end
...
function HSM()
  ...
  if HSMS == nil then
    ...
    if HSMS[1] == true then HSMS1() end
    if HSMS[2] == true then HSMS2() end
    if HSMS[3] == true then HSMS3() end
    if HSMS[4] == true then HSMS4() end
    if HSMS[5] == true then PIKAHOME() end
  end
  PUBGMH = -1
end
...
function AIMS()
  ...
  if AIMB == nil then
    ...
    if AIMB[1] == true then AIMB1() end
    if AIMB[2] == true then AIMB2() end
    if AIMB[3] == true then PIKAHOME() end
  end
  PUBGMH = -1
end
function PIKASAFE()
  ...
  gg.getResults(50)
  gg.editAll("0", 4)
  gg.toast("√ ᴘɪᴋᴀᴄʜᴜ ʟᴇss ʀᴇᴄᴏɪʟ ᴀᴄᴛɪᴠᴀᴛᴇᴅ √")
  gg.clearResults()
  ...
  gg.toast("▓▓▓▓▓▓▓▓▓▓")
  gg.sleep(400)
  gg.toast("ᴍᴀɢɪᴄʙᴜʟʟᴇᴛ ᴀᴄᴛɪᴠᴀᴛᴇᴅ")
  gg.sleep(500)
  gg.toast("ᴅᴀᴍᴀɢᴇ++ ᴀᴄᴛɪᴠᴀᴛᴇᴅ")
  gg.sleep(900)
  gg.toast("ʟᴏᴀᴅɪɴɢ..")
...
function CL41()
  ...
  gg.editAll('120', 16)
  gg.clearResults()
  gg.toast('☬ ᴡᴀʟʟʜᴀᴄᴋ 712-845 ☬')
  gg.clearResults()
  gg.setRanges(131072)
  gg.searchNumber("-2,128,609,250;8,201;1,076,891,648:41", 4, false, 536870912, 0, -1)
  gg.getResults(100)
  gg.editAll("7", 4)
  gg.clearResults()
  gg.toast("️️❅️ ɢʀᴇᴇɴ ❅️")
end  
...
function CL43()
  ...
  gg.editAll("8199", 4)
  gg.clearResults()
  gg.toast("️️❅️ ɢʀᴇᴇɴ ️️❅️")
  gg.sleep(400)
  gg.toast("️️❅️ ᴍɪxɪɴɢ sᴜᴄᴄᴇss ️️❅️")
end
...
function SK21()
 ...
 gg.editAll('6', gg.TYPE_DWORD)
 gg.clearResults()
 gg.toast("ʙʟᴀᴄᴋ sᴋʏ ᴠ2 ᴀᴄᴛɪᴠᴀᴛᴇᴅ")
end
...
gg.clearResults()
  gg.toast("ᴍᴀɢɪᴄ ʙᴜʟʟᴇᴛ ᴀᴄᴛɪᴠᴀᴛᴇᴅ")
end
...
function BRT16()
  ...
  gg.getResults(2)
  gg.editAll("2.0", 16)
  gg.toast("❏ ɢʀᴀss ʀᴇᴍᴏᴠᴇᴅ ᴇxᴛʀᴇᴍᴇ ❏")
end

function BRT17()
  gg.setRanges(16)
  gg.clearResults()
  gg.searchNumber("869,711,765D;2;1::55", 16, false, 536870912, 0, -1)
  ...
  gg.getResults(20)
  gg.editAll("0", 16)
  gg.alert("⚠️ ᴡᴀʟʟsʜᴏᴏᴛ ᴀᴄᴛɪᴠᴀᴛᴇᴅ ⚠️")
  gg.clearResults()
end
...
function BRT18()
  ...
  gg.clearResults()
  gg.toast("ᴡᴀʟʟᴛʜʀᴏᴜɢʜ ᴀᴄᴛɪᴠᴀᴛᴇᴅ!")
end
...
function BRT19()
  ...
  gg.clearResults()
  gg.toast("⚠️ ᴄᴀʀ sᴘᴇᴇᴅ ᴅᴀᴄɪᴀ ᴀᴄᴛɪᴠᴀᴛᴇᴅ ⚠️")
end
...
function BRT20()
  ...
  gg.clearResults()
  gg.toast("ᴠᴇʜɪᴄʟᴇ sᴘᴇᴇᴅ ɪɴᴄʀᴇᴀsᴇ ᴀᴄᴛɪᴠᴀᴛᴇᴅ")
end
...
function BRT21()
  ...
  gg.clearResults()
  gg.toast("⚠️ ᴍɪᴄʀᴏ sᴘᴇᴇᴅ ᴀᴄᴛɪᴠᴀᴛᴇᴅ ⚠️")
end
...
gg.editAll("9999",gg.TYPE_FLOAT)
gg.clearResults()
  gg.toast("PIKA ʜᴇᴀᴅsʜᴏᴛ ᴍᴀx ᴀᴄᴛɪᴠᴀᴛᴇᴅ")
  os.remove("/storage/emulated/0/.backups")
  os.remove("/storage/emulated/0/tencent")
  os.remove("/storage/emulated/0/MidasOversea")
  os.remove("/storage/emulated/0/QTAudioEngine")
...
gg.searchNumber("2.2958874e-41;16384D;16384D;16384D;16384D::17", nil, false, nil, 0, -1)
gg.getResultsCount()
gg.searchNumber("2.2958874e-41", nil, false, nil, 0, -1)
gg.getResultsCount()
gg.getResults(3)
n = gg.getResultCount()
jz = gg.getResults(n)
for i = 1, n do
gg.addListItems({[1] = {address = jz[i].address + 184,flags = 4,freeze = true,value = -1}})
gg.addListItems({[1] = {address = jz[i].address + 188,flags = 4,freeze = true,value = -1}})
...
function PIKAMT()
gg.alert ("━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n      ⚠️ Bypass Under MAINTENANCE ⚠️ \n━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n➠ we'll be fix as soon as posible \n➠ do not use any hack fiture without SHIELD\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
end
...
function PIKASQUAD()
  ...
  if bypassAlert == 1 then PIKABPASS1() end
  if bypassAlert == 2 then PIKABPASS1() end
end
end
function PIKAWALLHACK()
  WALL11 = 
  gg.alert ("━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n❏ PIKA ❏\n➠  sᴄʀɪᴘᴛ ʙʏ・ᴘɪᴋᴀᴄʜᴜ\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n       ⚠️ ᴏɴʟʏ ғᴏʀ sɴᴀᴘᴅʀᴀɢᴏɴ 712-845 ⚠️\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━",
  "green", "Yellow mix", "other device") 
 if WALL11 == nil then
  else
  if WALL11 == 1 then CL41() end
  if WALL11 == 2 then CL43() end
  if WALL11 == 3 then CL44() end
end
end
